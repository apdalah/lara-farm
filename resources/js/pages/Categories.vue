  ...
  export default {
    ...
    methods: {
      ...
      deleteItem (item) {
        ...
        axios.delete('/api/categories/'+item.id).then(response=>console.log(response.data))
      },
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          ...
          axios.put('/api/categories/'+this.editedItem.id,this.editedItem).then(response=>console.log(response.data));
        } else {
          this.dataTable.push(this.editedItem);

          axios.post('/api/categories/',this.editedItem).then(response=>console.log(response.data));
        }
        this.close();
      },
    },
