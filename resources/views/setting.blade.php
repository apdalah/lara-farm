...
<div class="container">
	<section class="my-page">
        <div class="window-box">
          ...
          <form action="{{ route('edit-profile', auth()->guard('farmer')->user()->id)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="body text-left">
              <div class="button-group">
                <h2 class="jap-stroke text-center" data-text="ユーザーネーム">ユーザーネーム</h2>
                <input type="text" name="name" value="{{ auth()->guard('farmer')->user()->name}}" placeholder="ユーザーネームを入力">
              </div>
              <div class="button-group">
                <h2 class="jap-stroke text-center" data-text="電話番号">電話番号</h2>
                <input type="text" name="mobile" value="{{ auth()->guard('farmer')->user()->mobile}}" placeholder="000-0000-0000">
              </div>
